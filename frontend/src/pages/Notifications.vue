<template>
	<header
		class="sticky top-0 z-10 flex flex-row md:items-center justify-between bg-surface-white px-3 py-2.5 sm:px-5"
	>
	...
	<div class="w-full mx-auto px-5 pt-6 divide-y">
		...
		>
			<div
				class="flex items-start p-4 rounded-xl border border-gray-100 w-full space-x-4 cursor-pointer"
